...
html += '<dt class="MMGlobalNaviStyle Mega"><a href="https://www.hitachi.co.id/ice/aircompressor/index.html">Kompresor udara</a></dt>';
html += '<dd class="MMSet">';
html += '<div class="MM2Container">';
html += '<ul class="MM2ColumnArea">';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/osp.html"><img src="https://www.hitachi.co.id/ice/aircompressor/images/osp.jpg" width="230" height="100" alt="Hitachi in Asia"><strong><span>Kompresor Oil-flooded Screw</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/dsp.html"><img src="https://www.hitachi.co.id/ice/aircompressor/images/dsp.jpg" width="230" height="100" alt="Hitachi in Asia"> <strong><span> Kompresor Screw Oil-Free Hitachi</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/pc.html"><img src="https://www.hitachi.co.id/ice/aircompressor/images/pc.jpg" width="230" height="100" alt="Hitachi in Asia"><strong><span>Piston Kompresor</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/scroll.html"><img src="https://www.hitachi.co.id/ice/aircompressor/images/scroll.jpg" width="230" height="100" alt="Hitachi in Asia"><strong><span>Scroll kompressor</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/auxiliaries.html"><img src="https://www.hitachi.co.id/ice/aircompressor/images/auxiliaries.jpg" width="230" height="100" alt="Hitachi in Asia"><strong><span>Auxiliaries</span></strong></a></p></li>';

html += '</ul><!--/MM2ColumnArea-->';
html += '</div><!--/MM2Container-->';
html += '</dd><!--/MMSet-->';

html += '<dt class="MMGlobalNaviStyle  Mega"><a href="https://www.hitachi.co.id/ice/aircompressor/profile.html">Tentang Kami</a></dt>';
html += '<dd class="MMSet">';
html += '<div class="MM2Container">';
html += '<ul class="MM2ColumnArea">';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/profile.html"><strong><span>Profil Perusahaan</span></strong></p></a></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/history.html"><strong><span>Sejarah Kompresor Hitachi</span></strong></a></p></li>';
html += '</ul><!--/MM2ColumnArea-->';
html += '</div><!--/MM2Container-->';
html += '</dd><!--/MMSet-->';
html += '<dt class="MMGlobalNaviStyle"><a href="https://www.hitachi.asia/ice/news/index.html">Warta</a></dt>';
html += '<dt class="MMGlobalNaviStyle"><a href="https://www.hitachi.co.id/ice/aircompressor/contact.html">Hubungi Kami</a></dt>';
html += '</dl>';
