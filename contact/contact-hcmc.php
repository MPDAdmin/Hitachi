...
$errors = '';
$mail->addAddress("thanh.nguyen.cg@hitachi.com; HIES-MSM-marketing@hitachi-ies.co.jp; christina.wah.cq@hitachi.com;");
...
$mail->addAddress("thanh.nguyen.cg@hitachi.com; HIES-MSM-marketing@hitachi-ies.co.jp; christina.wah.cq@hitachi.com;", "Hitachi-ICE");

        $headers  = "From: " . strip_tags($email) . "\r\n";
        $headers .= "Reply-To: ". strip_tags($email) . "\r\n";
	
$mail->Subject = "Enquiry form submission: Ho Chi Minh City Representative Office";
...
<html>
<head>
	<title>Hitachi ICE Website - Enquiry (Ho Chi Minh City Representative Office)</title>
</head>
