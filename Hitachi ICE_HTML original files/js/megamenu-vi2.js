...
html += '<div style="position: relative;color: black !important;z-index: 9 !important;width: 965px;height: 35px;margin: -20px auto;text-align: right;font-size: 11px;"><a href="https://www.hitachi.com.vn/eng/ice/aircompressor/" target="_blank">Visit Air Compressor Page in English</a></div>';
html += '<dt class="MMGlobalNaviStyle Mega"><a href="../index.html">Máy nén khí</a></dt>';
html += '<dd class="MMSet">';
html += '<div class="MM2Container">';
html += '<ul class="MM2ColumnArea">';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../osp.html"><img src="https://www.hitachi.com.vn/eng/ice/aircompressor/images/osp.jpg" width="230" height="100" alt="Hitachi in Singapore"><strong><span>Máy nén trục vít có dầu Hitachi</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../dsp.html"><img src="https://www.hitachi.com.vn/eng/ice/aircompressor/images/dsp.jpg" width="230" height="100" alt="Hitachi in Singapore"><strong><span>Máy nén trục vít không dầu Hitachi</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../pc.html"><img src="https://www.hitachi.com.vn/eng/ice/aircompressor/images/pc.jpg" width="230" height="100" alt="Hitachi in Singapore"><strong><span>Máy nén Piston</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../scroll.html"><img src="https://www.hitachi.com.vn/eng/ice/aircompressor/images/scroll.jpg" width="230" height="100" alt="Hitachi in Singapore"><strong><span> Máy nén dạng cuộn</span></strong></a></p></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../auxiliaries.html"><img src="https://www.hitachi.com.vn/eng/ice/aircompressor/images/auxiliaries.jpg" width="230" height="100" alt="Hitachi in Singapore"><strong><span>Thiết bị Phụ trợ</span></strong></a></p></li>';

html += '</ul><!--/MM2ColumnArea-->';
html += '</div><!--/MM2Container-->';
html += '</dd><!--/MMSet-->';

html += '<dt class="MMGlobalNaviStyle  Mega"><a href="../profile.html">Về chúng tôi</a></dt>';
html += '<dd class="MMSet">';
html += '<div class="MM2Container">';
html += '<ul class="MM2ColumnArea">';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../profile.html"><strong><span>Hồ sơ công ty</span></strong></p></a></li>';
html += '<li class="MMGrid1 MMFirstItem"><p class="MMBannerLinkStyle"><a href="../history.html"><strong><span>Lịch sử máy nén khí Hitachi</span></strong></a></p></li>';
html += '</ul><!--/MM2ColumnArea-->';
html += '</div><!--/MM2Container-->';
html += '</dd><!--/MMSet-->';
html += '<dt class="MMGlobalNaviStyle"><a href="https://www.hitachi.asia/ice/news/index.html">Các bản tin</a></dt>';
html += '<dt class="MMGlobalNaviStyle"><a href="../contact.html">Liên hệ với chúng tôi</a></dt>';
html += '</dl>';
